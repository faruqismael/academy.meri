...
export const cursorAnimation = () => {
  ...
  const scale_up_all = document.querySelectorAll(
    ".mil-word-1-trigger, .mil-word-2-trigger, .mil-icon-1-trigger, .mil-icon-2-trigger, .mil-icon-3-trigger"
  );
...
export const cursorSwiperAnimation = () => {
  ...
  //accent color
  const accent = document.querySelectorAll(
    ".swiper-container .mil-accent-trigger"
  );
  if (accent != undefined) {
    accent.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  const light = document.querySelectorAll(
    ".swiper-container .mil-light-trigger"
  );
  if (light != undefined) {
    light.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  const hidden = document.querySelectorAll(
    ".swiper-container .mil-hidden-trigger"
  );
  if (hidden != undefined) {
    hidden.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //scale down
  const scale_down = document.querySelectorAll(
    ".swiper-container .mil-scale-down-trigger"
  );
  if (scale_down != undefined) {
    scale_down.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //scale up
  const scale_up = document.querySelectorAll(
    ".swiper-container .mil-scale-up-trigger"
  );
  if (scale_up != undefined) {
    scale_up.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //scale up with word and icons
  const scale_up_all = document.querySelectorAll(
    ".swiper-container .mil-word-1-trigger, .swiper-container .mil-word-2-trigger, .swiper-container .mil-icon-1-trigger, .swiper-container .mil-icon-2-trigger, .swiper-container .mil-icon-3-trigger"
  );
  if (scale_up_all != undefined) {
    scale_up_all.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //word 1
  const word1 = document.querySelectorAll(
    ".swiper-container .mil-word-1-trigger"
  );
  if (word1 != undefined) {
    word1.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //word 2
  const word2 = document.querySelectorAll(
    ".swiper-container .mil-word-2-trigger"
  );
  if (word2 != undefined) {
    word2.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //icon 1
  const icon1 = document.querySelectorAll(
    ".swiper-container .mil-icon-1-trigger"
  );
  if (icon1 != undefined) {
    icon1.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //icon 2
  const icon2 = document.querySelectorAll(
    ".swiper-container .mil-icon-2-trigger"
  );
  if (icon2 != undefined) {
    icon2.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
  ...
  //icon 3
  const icon3 = document.querySelectorAll(
    ".swiper-container .mil-icon-3-trigger"
  );
  if (icon3 != undefined) {
    icon3.forEach((element) => {
      element.addEventListener("mouseover", (event) => {
